package com.naisa.stock_sync_scheduler.constants;
...
class VendorTypeEnumTest {
    ...
    void vendorTypeEnum_shouldHaveVendorAValue() {
        // Act & Assert
        assertTrue(VendorTypeEnum.VENDOR_A_API.name() != null);
    ...
    void vendorTypeEnum_shouldHaveVendorBValue() {
        // Act & Assert
        assertTrue(VendorTypeEnum.VENDOR_B_CSV.name() != null);
    ...
    void vendorTypeEnum_valueOf_withInvalidValue_shouldThrowException() {
        // Act & Assert
        assertThrows(IllegalArgumentException.class, () -> VendorTypeEnum.valueOf("INVALID_VENDOR"));
    }
    ...
    void vendorTypeEnum_ordinal_shouldBeConsistent() {
        ...
        // Assert - ordinals should be different and sequential
